/**
 * Icon geometry, kept apart from the component that draws it. The content
 * layer types itself against `IconName`, and build-time tooling (the SEO and
 * prerender plugins) imports that content from Node — so this registry stays
 * free of JSX and of any DOM-only type.
 */
export const iconPaths = {
  bolt: 'M13 2 4.5 13.5H11L10 22l8.5-11.5H12z',
  fingerprint:
    'M12 11v3a9 9 0 0 1-1.2 4.5M7.5 6.2a8 8 0 0 1 12 6.3M4.5 15.5A9 9 0 0 1 4 12a8 8 0 0 1 1.6-4.8M16 13a13 13 0 0 1-1 6M8 11a4 4 0 0 1 8 0v1',
